...
export const Checkpro = () =>{
    ...
    return (proInfoLoading?<Spin>loading...</Spin>:
        ...
        <Space style={{width:'100%'}} direction={'vertical'}><Descriptions bordered  >
                    ...
                    <Descriptions.Item span={3} label={t(Lang === 1?'admin.project.columns_detail_title.14':Lang === 2?'admin.project.columns_detail_title_en.14':'admin.project.columns_detail_title_mix.14')}>
                        {proInfo.difficulty}
                    </Descriptions.Item>
